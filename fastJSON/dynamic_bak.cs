...
namespace fastJSON
{
    internal class DynamicJson_bak : DynamicObject, IEnumerable
    {
        private IDictionary<string, object> _dictionary { get; set; }
        private List<object> _list { get; set; }

        public DynamicJson_bak(string json)
        {
        ...
        private DynamicJson_bak(object dictionary)
        {
        ...
        IEnumerator IEnumerable.GetEnumerator()
        {
            ...
            {
                yield return new DynamicJson_bak(o as IDictionary<string, object>);
            }
        }
    }
}
